...
class Place3 {
    ...
    func objectDescription(otherNumber: Int) -> String {
        return "Place object: \(description). Other additional number: \(otherNumber)"
    }
}
...
print(somePlace3.objectDescription(otherNumber: 42))
